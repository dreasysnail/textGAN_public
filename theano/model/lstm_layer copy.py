...
def decoder2(params,z, max_step, prefix='decoder'):
    ...
    def _step(x_prev, h_prev, c_prev, U, W, C , b, Vhid, b_y):
    ...
    y0 = tensor.dot(h0, params['Vhid']) + params[_p(prefix, 'b_y')]
    ...
    rval, updates = theano.scan(_step,
                                ...
                                non_sequences = [params[_p(prefix, 'U')], params[_p(prefix, 'W')], params[_p(prefix, 'C')], params[_p(prefix, 'b')],params['Vhid'],  params[_p(prefix, 'b_y')]],
                                name=_p(prefix, '_layers'),
                                n_steps=max_step,
                                strict=True)
